...
@Component({
  selector: 'app-factura-sujeto-excluido-items',
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule],
  templateUrl: './factura-sujeto-excluido-items.component.html',
      styleUrl: './factura-sujeto-excluido-items.component.scss'
})
export class FacturaSujetoExcluidoItemsComponent {
