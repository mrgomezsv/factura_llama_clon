...
@Component({
  selector: 'app-comprobante-credito-fiscal-items',
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule],
  templateUrl: './comprobante-credito-fiscal-items.component.html',
      styleUrl: './comprobante-credito-fiscal-items.component.scss'
})
export class ComprobanteCreditoFiscalItemsComponent {
