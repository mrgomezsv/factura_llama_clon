...
@Component({
  selector: 'app-nota-remision-otros',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './nota-remision-otros.component.html',
      styleUrl: './nota-remision-otros.component.scss'
})
export class NotaRemisionOtrosComponent { 
  collapsed = true; 
