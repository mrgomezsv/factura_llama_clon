...
@Component({
  selector: 'app-nota-remision-cliente',
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule],
  templateUrl: './nota-remision-cliente.component.html',
      styleUrl: './nota-remision-cliente.component.scss'
})
export class NotaRemisionClienteComponent {
