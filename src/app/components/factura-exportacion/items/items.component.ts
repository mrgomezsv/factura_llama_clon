...
export class FacturaExportacionItemsComponent {
  ...
  productMenu = false;
  allProducts: Array<{ id: string; nombre: string; codigo?: string; precioConIva?: number }> = [];
  filteredProducts: Array<{ id: string; nombre: string; codigo?: string; precioConIva?: number }> = [];
