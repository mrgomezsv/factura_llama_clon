      ...
      <div class="drawer" (click)="$event.stopPropagation()">
        ...
        <div class="factura-layout">
          <div class="panel-izquierdo">
            <app-factura-sujeto-excluido-cliente (changed)="onCliente($event)" />
            <app-factura-sujeto-excluido-sucursal />
            <app-factura-sujeto-excluido-retenciones (changed)="onRetenciones($event)" />
            <app-factura-sujeto-excluido-descuentos (changed)="onDescuento($event)" />
            <app-factura-sujeto-excluido-responsables />
            <app-factura-sujeto-excluido-otros />
            <app-factura-sujeto-excluido-appendices />
            <app-factura-sujeto-excluido-items (itemsChanged)="onItems($event)" />
