  ...
  template: `
    <div class="factura-layout">
      <div class="panel-izquierdo">
        ...
        <app-factura-retenciones />
        <app-factura-descuentos />
      ...
      <div class="panel-derecho">
        <div class="placeholder-totales">
          <p>No se han agregado ítems</p>
          <small>No es posible registrar ventas sin añadir productos o servicios.</small>
        </div>
        <div class="tabla-totales">
          <!-- Totales simulados -->
          <div class="tot-row"><span>Suma de Ventas Gravadas</span><span>$0.00</span></div>
          ...
          <div class="tot-row"><span>Sub Total</span><span>$0.00</span></div>
          <div class="tot-row"><span>(-)IVA Retenido</span><span>$0.00</span></div>
          <div class="tot-row"><span>(-)Retención Renta</span><span>$0.00</span></div>
          <div class="tot-row total"><span>Total a Pagar</span><span>$0.00</span></div>
        </div>
      </div>
    </div>
  `,
