      ...
      <div class="drawer" (click)="$event.stopPropagation()">
        ...
        <div class="factura-layout">
          <div class="panel-izquierdo">
            <app-nota-remision-cliente (changed)="onCliente($event)" />
            <app-nota-remision-sucursal />
            <app-nota-remision-retenciones (changed)="onRetenciones($event)" />
            <app-nota-remision-descuentos (changed)="onDescuento($event)" />
            <app-nota-remision-responsables />
            <app-nota-remision-otros />
            <app-nota-remision-appendices />
            <app-nota-remision-items (itemsChanged)="onItems($event)" />
