      ...
      <div class="drawer" (click)="$event.stopPropagation()">
        ...
        <div class="factura-layout">
          <div class="panel-izquierdo">
            <app-nota-credito-cliente (changed)="onCliente($event)" />
            <app-nota-credito-sucursal />
            <app-nota-credito-retenciones (changed)="onRetenciones($event)" />
            <app-nota-credito-descuentos (changed)="onDescuento($event)" />
            <app-nota-credito-responsables />
            <app-nota-credito-otros />
            <app-nota-credito-appendices />
            <app-nota-credito-items (itemsChanged)="onItems($event)" />
