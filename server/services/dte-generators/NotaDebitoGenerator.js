...
class NotaDebitoGenerator extends BaseGenerator {
    generate(data) {
        const {
            empresaConfig,
            cliente,
        ...
        // Body Construction
        const itemsBuilt = this.buildItemsStandard(items, 'NDB');
    ...
    buildReceptor(cliente) {
        // Use NCR logic for now as it handles both taxpayers and consumers
        return super.buildReceptor(cliente, 'NCR');
    }
}

module.exports = NotaDebitoGenerator;
